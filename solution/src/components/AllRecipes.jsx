...
export default function AllRecipes(props) {
    ...
    useEffect(() => {
        ...
        fetch("https://cs571api.cs.wisc.edu/rest/su25/ice/pizza", {
            headers: {
        ...
        fetch("https://cs571api.cs.wisc.edu/rest/su25/ice/pasta", {
            headers: {
                "X-CS571-ID": CS571.getBadgerId()
            }
        })
